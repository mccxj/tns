...
/*  61 */   private Message message = null;
  ...
  {
/* 184 */     this.errorNumber = paramInt;
/* 185 */     this.message = new Message11();
  }
  
  public NetException(int paramInt, String paramString)
  {
/* 193 */     this(paramInt);
/* 194 */     this.userMsg = paramString;
  }
  
  public int getErrorNumber()
  {
/* 202 */     return this.errorNumber;
  }
  
  public String getMessage()
  {
/* 218 */     if (this.message == null) {
/* 219 */       return Integer.toString(this.errorNumber);
    }
    
/* 222 */     return this.message.getMessage(this.errorNumber, this.userMsg);
  }
}
/* Location:              /home/caixj/下载/ojdbc6.jar!/oracle/net/ns/NetException.class
