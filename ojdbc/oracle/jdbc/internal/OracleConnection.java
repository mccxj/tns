  ...
  extends oracle.jdbc.OracleConnection
{
  ...
  public abstract void cleanupAndClose(boolean paramBoolean) throws SQLException;
  ...
  public abstract CLOB createClob(byte[] paramArrayOfByte) throws SQLException;
  
  public abstract CLOB createClobWithUnpickledBytes(byte[] paramArrayOfByte) throws SQLException;
  
  public abstract CLOB createClob(byte[] paramArrayOfByte, short paramShort) throws SQLException;
  
  public abstract BLOB createBlob(byte[] paramArrayOfByte) throws SQLException;
  
  public abstract BLOB createBlobWithUnpickledBytes(byte[] paramArrayOfByte) throws SQLException;
  
  public abstract BFILE createBfile(byte[] paramArrayOfByte) throws SQLException;
  
  public abstract boolean isDescriptorSharable(OracleConnection paramOracleConnection) throws SQLException;
  
  public abstract OracleStatement refCursorCursorToStatement(int paramInt) throws SQLException;
  ...
  public abstract byte[] createLightweightSession(String paramString, KeywordValueLong[] paramArrayOfKeywordValueLong, int paramInt, KeywordValueLong[][] paramArrayOfKeywordValueLong1, int[] paramArrayOfInt) throws SQLException;
  
  public abstract void executeLightweightSessionRoundtrip(int paramInt1, byte[] paramArrayOfByte, KeywordValueLong[] paramArrayOfKeywordValueLong, int paramInt2, KeywordValueLong[][] paramArrayOfKeywordValueLong1, int[] paramArrayOfInt) throws SQLException;
  
  public abstract void executeLightweightSessionPiggyback(int paramInt1, byte[] paramArrayOfByte, KeywordValueLong[] paramArrayOfKeywordValueLong, int paramInt2) throws SQLException;
  
  public abstract void doXSNamespaceOp(XSOperationCode paramXSOperationCode, byte[] paramArrayOfByte, XSNamespace[] paramArrayOfXSNamespace, XSNamespace[][] paramArrayOfXSNamespace1) throws SQLException;
  
  public abstract void doXSNamespaceOp(XSOperationCode paramXSOperationCode, byte[] paramArrayOfByte, XSNamespace[] paramArrayOfXSNamespace) throws SQLException;
  ...
  public abstract void addXSEventListener(XSEventListener paramXSEventListener) throws SQLException;
  
  public abstract void addXSEventListener(XSEventListener paramXSEventListener, Executor paramExecutor) throws SQLException;
  
  public abstract void removeXSEventListener(XSEventListener paramXSEventListener) throws SQLException;
  
  public abstract int getTimezoneVersionNumber() throws SQLException;
  
  public abstract TIMEZONETAB getTIMEZONETAB() throws SQLException;
  
  public abstract String getDatabaseTimeZone() throws SQLException;
  
  public abstract boolean getTimestamptzInGmt();
  
  public abstract boolean getUse1900AsYearForTime();
  
  public abstract boolean isDataInLocatorEnabled() throws SQLException;
  
  public abstract boolean isLobStreamPosStandardCompliant() throws SQLException;
  
  public abstract long getCurrentSCN() throws SQLException;
  
  public abstract EnumSet<TransactionState> getTransactionState() throws SQLException;
  
  public abstract boolean isConnectionSocketKeepAlive() throws SocketException, SQLException;
  
  public static enum InstanceProperty
  {
/* 318 */     ASM_VOLUME_SUPPORTED, 
...
/* 331 */     INSTANCE_TYPE;
  ...
  {
/* 342 */     TRANSACTION_STARTED, 
    
/* 346 */     TRANSACTION_ENDED, 
    
/* 350 */     TRANSACTION_READONLY, 
    
/* 355 */     TRANSACTION_INTENTION;
  ...
  {
/* 902 */     NAMESPACE_CREATE(1), 
/* 903 */     NAMESPACE_DELETE(2), 
/* 904 */     ATTRIBUTE_CREATE(3), 
/* 905 */     ATTRIBUTE_SET(4), 
/* 906 */     ATTRIBUTE_DELETE(5), 
/* 907 */     ATTRIBUTE_RESET(6);
    
    private final int code;
    
/* 911 */     private XSOperationCode(int paramInt) { this.code = paramInt; }
...
/* Location:              /home/caixj/下载/ojdbc6.jar!/oracle/jdbc/internal/OracleConnection.class
