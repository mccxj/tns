...
/*  76 */     this.mare = paramT4CMAREngine;
/*  77 */     this.definedColumnType = paramInt7;
/*  78 */     this.definedColumnSize = paramInt8;
  }
...
/* 305 */     if (this.rowSpaceIndicator == null)
    {
/* 307 */       localSQLException = DatabaseError.createSqlException(getConnectionDuringExceptionHandling(), 21);
...
/* 314 */       switch (this.definedColumnType)
      ...
      case 1: 
      case 12: 
/* 328 */         return getString(paramInt);
      
      case -104: 
/* 331 */         return getINTERVALDS(paramInt);
      
      case -4: 
      case -3: 
      case -2: 
/* 338 */         return getBytes(paramInt);
      }
...
/* 356 */   private static final String _Copyright_2007_Oracle_All_Rights_Reserved_ = null;
  public static final boolean TRACE = false;
}
/* Location:              /home/caixj/下载/ojdbc6.jar!/oracle/jdbc/driver/T4CIntervaldsAccessor.class
