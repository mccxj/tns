...
/* 284 */     return str;
  ...
  String toText(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, int paramInt6, int paramInt7, boolean paramBoolean, String paramString)
    throws SQLException
  {
/* 308 */     if ((this.definedColumnType == 0) || (this.definedColumnType == 93))
    {
...
/* 637 */       switch (this.definedColumnType)
      ...
      case 1: 
      case 12: 
/* 652 */         return getString(paramInt);
      
      case 93: 
/* 655 */         return getTimestamp(paramInt);
      
      case 91: 
/* 658 */         return getDate(paramInt);
      
      case 92: 
/* 661 */         return getTime(paramInt);
      
      case -4: 
      case -3: 
      case -2: 
/* 668 */         return getBytes(paramInt);
      }
      
      
/* 672 */       localSQLException = DatabaseError.createSqlException(getConnectionDuringExceptionHandling(), 4);
...
/* 686 */   private static final String _Copyright_2007_Oracle_All_Rights_Reserved_ = null;
  public static final boolean TRACE = false;
}
/* Location:              /home/caixj/下载/ojdbc6.jar!/oracle/jdbc/driver/T4CTimestampAccessor.class
